...
from findysport_app.views import index
...
from findysport_app.views import UsuarioCreateView, UsuarioDeleteView, UsuarioUpdateView
...
urlpatterns = [
    ...
    path('actividad/<int:pk>/update/', ActividadUpdateView.as_view(), name='actividad-update'),
    ...
    path('apuntado/<int:pk>/update/', ApuntadoUpdateView.as_view(), name='apuntado-update'),
    ...
    path('encargado/<int:pk>/update/', EncargadoUpdateView.as_view(), name='encargado-update'),
    ...
    path('local/<int:pk>/update/', LocalUpdateView.as_view(), name='local-update'),
    ...
    path('usuario/<int:pk>/update/', UsuarioUpdateView.as_view(), name='usuario-update'),
